...
module ZtAdmin
  ...
  begin
    ...
    FileUtils.cp "#{generic}/Procfile.dev", "#{AppRoot}/Procfile.dev"
    action_report "Procfile.dev"
  ...
  ### Get generic files in the *vendor* directory
    ...
    if (ZtAdmin::VERSION[0] == '1')    # folder 'vendor' is for v.1
    ...
    # Folders 'assets/javaqscripts' & 'assets/stylesheets' are for v.1
    if (ZtAdmin::VERSION[0] == '1') 
